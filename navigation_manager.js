...
// MODIFICAÇÃO: Importar a nova função de atualização e a renderização principal
...
// *** MODIFICAÇÃO: Importar showTopAlert ***
    ...
    const closeForm = (section) => {
        if (section.id === 'creation-section') {
            resetCharacterFormState(); // Reset specific to character form
             ...
             // Basic reset for spell/habilidade form (clearing fields handled by browser reset usually)
        ...
        document.getElementById('main-content').classList.remove('hidden');
         // Mostra a barra de navegação desktop novamente
        const desktopNav = document.getElementById('desktop-sidebar');
